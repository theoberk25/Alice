...
| Pi pipeline acceptance | [Joint checklist](../integration/pi-technician-acceptance.md) | lab.first_light.check_pipeline is read-only; run on Pi beside the existing service |
