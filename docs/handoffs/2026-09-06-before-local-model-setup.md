# Checkpoint before local model setup

Preserved 2026-09-06 before replacing the current snapshot. All status and test
claims below are historical; the active task is the user-authorized agent-host
model installation. Follow [AGENTS.md](../../AGENTS.md).
...
[Popup setup/evidence](../reports/2026-09-06-popup-testing-app.md).
Worktree: `artifacts/console/main-redesign-integration` within the original checkout.
[Integration evidence](../reports/2026-09-06-main-redesign-integration.md).
...
- Late telemetry alignment is included: battery units, LED roles and updated team
  docs/tracker row 035. [Team checkpoint](2026-09-06-before-telemetry-redesign-merge.md).
...
unchanged. [Team checkpoint](2026-09-06-before-pr-thermal-deployment-merge.md).
...
[source](2026-09-06-before-redesign-integration-source.md) and
[team](2026-09-06-before-redesign-integration-team.md).
...
[Design sources](../guides/console/visual-sources.md) ·
[Original transfer handoff](2026-09-06-new-repository-merge.md)
