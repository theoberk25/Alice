...
Run these commands from the repository root. The migration imports source and locks, not `.env`, toolchains, models, native databases or installed services. See the [main workstation guide](../workstation.md).
