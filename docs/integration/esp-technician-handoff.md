...
| Current controller | XIAO ESP32-S3 on the Pi's USB port, `--esp-serial` | Real LED driven and read back; see the [serial protocol](../contracts/esp-serial-protocol.md). The HTTP mock at `http://127.0.0.1:8090` is retained for tests |
